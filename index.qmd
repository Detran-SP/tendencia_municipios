...
- **Óbitos em estadas e rodovias**: `r list_mun_count_pos[[3]]` municípios
...
#| tbl-cap: Municípios com tendência significativa de aumento na quantidade de óbitos em estadas e rodovias
...
- **Óbitos em estadas e rodovias**: `r list_mun_count_neg[[3]]` municípios
...
#| tbl-cap: Municípios com tendência significativa de redução na quantidade de óbitos em estadas e rodovias
...
#| fig-cap: Mapa da tendência resultante, considerando os óbitos em estadas e rodovias
...
- **Sinistros com vítimas feridas (leves e graves - estadas e rodovias)**: `r list_mun_count_pos[[9]]` municípios
...
#| tbl-cap: Municípios com tendência significativa de aumento na quantidade de sinistros com vítimas feridas (leves e graves - estadas e rodovias)
...
- **Sinistros com vítimas feridas (leves e graves - estadas e rodovias)**: `r list_mun_count_neg[[9]]` municípios
...
#| tbl-cap: Municípios com tendência de redução na quantidade de sinistros com vítimas feridas (leves e graves - estadas e rodovias)
...
#| fig-cap: Mapa da tendência resultante, considerando os sinistros com vítimas feridas (leves e graves) em estadas e rodovias
